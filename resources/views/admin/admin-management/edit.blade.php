...
<div class="amc-wrap">
    ...
    <div class="amc-header">
        <div>
            ...
            <div class="amc-title">Edit Admin Account</div>
            <div class="amc-sub">Update administrator details and permissions.</div>
        </div>
    </div>

    @if(session('success'))
        <div class="amc-alert amc-alert--success">
    ...
    @if($errors->any())
        <div class="amc-alert amc-alert--error">
        ...
        <div class="amc-grid">
            ...
            <div class="amc-panel">
                ...
                <div class="amc-panel__body">
                    <div class="amc-field">
                        ...
                        @error('name')<div class="amc-error">{{ $message }}</div>@enderror
                    </div>
                    ...
                    <div class="amc-field">
                        ...
                        @error('email')<div class="amc-error">{{ $message }}</div>@enderror
                    </div>
                    ...
                    <div class="amc-field">
                        ...
                        <input type="text" name="mobile_number" class="amc-input @error('mobile_number') amc-input--error @enderror"
                               value="{{ old('mobile_number', $admin->mobile_number) }}" placeholder="+91 98765 43210" required>
                        @error('mobile_number')<div class="amc-error">{{ $message }}</div>@enderror
                    </div>
            ...
            <div class="amc-panel">
                ...
                <div class="amc-panel__body">
                    <div class="amc-field">
                        ...
                        @error('role')<div class="amc-error">{{ $message }}</div>@enderror
                    </div>
                    ...
                    <div id="permissionsSection" class="amc-perms" style="{{ old('role', $admin->role) == 'super_admin' ? 'display:none' : '' }}">
                        ...
                        <div class="amc-perms-grid">
                            @foreach($modules as $key => $module)
                                @php
                                    ...
                                    $checked = in_array($key, old('permissions', $adminPerms));
                                @endphp
                        ...
                        @error('permissions')<div class="amc-error">{{ $message }}</div>@enderror
                    </div>
                </div>
            </div>
            ...
            <div class="amc-panel">
                ...
                <div class="amc-panel__body">
                    ...
                    <div class="amc-field">
                        <label class="amc-label">New Password</label>
                        <input type="password" name="password" class="amc-input @error('password') amc-input--error @enderror" placeholder="Enter new password">
                        @error('password')<div class="amc-error">{{ $message }}</div>@enderror
                    </div>
                    <div class="amc-field">
                        <label class="amc-label">Confirm New Password</label>
                        <input type="password" name="password_confirmation" class="amc-input" placeholder="Confirm new password">
                    </div>
                </div>
            </div>
...
/* ALERTS */
.amc-alert{display:flex;align-items:center;gap:10px;padding:12px 16px;border-radius:10px;font-size:13px;font-weight:500;margin-bottom:20px}
.amc-alert--success{background:#dcfce7;color:#15803d;border:1px solid #bbf7d0}
.amc-alert--error{background:#fee2e2;color:#b91c1c;border:1px solid #fecaca}
...
.amc-switch input[type="checkbox"]{display:none}
.amc-switch input[type="hidden"]{display:none}
...
.amc-switch input[type="checkbox"]:checked ~ .amc-switch__slider{background:#3b82f6}
.amc-switch input[type="checkbox"]:checked ~ .amc-switch__slider::after{left:23px}
