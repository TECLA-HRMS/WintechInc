              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    <form id="additem" action="{{route('admin.blog-category.store')}}" method="POST">
                        @csrf
                        <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-4">
                            <label for="name">Name</label>
                            <input type="text" id="name" class="form-control" name="name" value="{{old('name')}}" onkeyup="checkname(event.target.value)">
                        </div>
                        <div class="form-group col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-4">
