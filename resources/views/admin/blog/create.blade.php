...
<div class="ec-page">
    ...
    <div class="ec-header">
        <div>
            <h1><i class="fa-solid fa-pencil me-2" style="color:var(--primary)"></i>Add Blog Post</h1>
                ...
                <div class="row">
                    <div class="col-md-8">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="title" class="field-input {{ $errors->has('title') ? 'is-invalid' : '' }}" value="{{ old('title') }}" placeholder="Enter post title" required>
                            @error('title')
                        ...
                        <div class="mb-4">
                            ...
                            <textarea id="content" name="content" class="field-input {{ $errors->has('content') ? 'is-invalid' : '' }}">{{ old('content') }}</textarea>
                            @error('content')
                                <div class="field-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="excerpt" rows="3" class="field-input {{ $errors->has('excerpt') ? 'is-invalid' : '' }}" placeholder="A short description..." required>{{ old('excerpt') }}</textarea>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="published_at" class="field-input {{ $errors->has('published_at') ? 'is-invalid' : '' }}" value="{{ old('published_at') }}" required>
                            @error('published_at')
                                <div class="field-error"><i class="fa-solid fa-circle-exclamation"></i> {{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <!-- Featured Image -->
                        <div class="mb-4">
                            <label class="field-label">Featured Image <span style="color:var(--danger)">*</span></label>
                            <input type="file" name="featured_image" class="field-input {{ $errors->has('featured_image') ? 'is-invalid' : '' }}" accept="image/*" required>
                            <small class="text-muted d-block mt-1" style="font-size: 0.75rem;">Recommended size: 1200x630 pixels</small>
                        ...
                        <div class="mb-4">
                            ...
                            <small class="text-muted d-block mt-1" style="font-size: 0.75rem;">You can upload multiple images (optional).</small>
