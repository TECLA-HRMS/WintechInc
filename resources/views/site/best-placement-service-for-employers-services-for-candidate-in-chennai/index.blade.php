        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 breadcrumb-1">
                    <h1 class="title" style="font-size: 38px;">Placement Service for Employers</h1>
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="bread-tag">
                        <a href="{{ url('/') }}">Home</a>
                        <span> / </span>
                        <a href="#" class="active">Placement Service for Employers</a>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-xl-7 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="service-detials-step-1">
                        <div class="thumbnail">
                            <img src="{{ asset('image/consultancy3.jpg') }}" alt="business-area">
                        </div>
                        <h4 class="title">Placement Service for Employers</h4>
                        <p class="disc">
                            Welcome to our Placement Service for Employers! We understand that finding the right talent for your organization is crucial for its growth and success. Our placement service is designed to assist you in identifying and hiring top-quality candidates who are the perfect fit for your company's needs. Partner with our Placement Service for Employers and let us assist you in finding the best talent for your organization. Our dedicated team is ready to understand your unique requirements and deliver exceptional candidates who will contribute to your company's success. Contact us today to discuss your staffing needs and explore how our placement service can benefit your organization.
                        </p>
                        ...
                        <div class="row g-5 mt--30 mb--40">
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Talent Acquisition Expertise</h6>
                                        <p class="disc">Our placement service specializes in talent acquisition and has a deep understanding of various industries and job roles. We have access to a wide network of qualified professionals and utilize our expertise to source and attract top talent for your organization. </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        ...
                                        <p class="disc">Hiring can be a time-consuming process that requires significant resources. Our placement service streamlines the recruitment process for you, saving you valuable time and effort. We handle all aspects of the hiring process, including job posting, candidate screening, conducting interviews, and reference checks.  </p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Ongoing Support</h6>
                                        <p class="disc"> Our commitment to your organization extends beyond the hiring process. We provide ongoing support, ensuring a smooth onboarding process for the selected candidates.  </p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Expertise in Candidate Assessment</h6>
                                        <p class="disc"> Assessing candidates can be challenging, particularly when it comes to evaluating their skills, cultural fit, and potential for long-term success within your organization. Our placement service has experience in assessing candidates through interviews, skills tests, and behavioral assessments.  </p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
