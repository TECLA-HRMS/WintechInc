        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 breadcrumb-1">
                    <h1 class="title" style="font-size: 38px;">Placement  Service for Manpower Executive (Employers)</h1>
                </div>
            ...
            <div class="row">
                <div class="col-xl-7 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="service-detials-step-1">
                        <div class="thumbnail">
                            <img src="{{ asset('image/consultancy9.jpg') }}" alt="business-area">
                        </div>
                        <h4 class="title">Placement  Service for Manpower Executive (Employers)</h4>
                        <p class="disc">
                           Welcome to our Placement Service for Manpower Executives! Our service is dedicated to helping employers find highly skilled and experienced manpower executives who can effectively manage and optimize the workforce within their organizations. 
                        </p>
                        ...
                        <div class="row g-5 mt--30 mb--40">
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Specialized Manpower Recruitment</h6>
                                        <p class="disc">Our placement service specializes in manpower recruitment, specifically targeting candidates with expertise in managing and overseeing the workforce. We understand the specific skills, qualifications, and experience required for manpower executive roles, including workforce planning, talent acquisition, employee engagement, performance management, and more.  </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        ...
                                        <p class="disc">  We have a wide network of talented manpower executives with diverse backgrounds and expertise. Our placement service connects with qualified candidates actively seeking manpower executive positions and maintains an updated database of potential candidates. </p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        ...
                                        <p class="disc"> We understand that every organization has unique manpower requirements. Our placement service works closely with you to understand your specific needs and create customized recruitment solutions. Whether you need a manpower executive for a specific project, a permanent position, or a temporary role, we tailor our approach to find the right fit for your organization. </p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
							<div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Manpower Industry Knowledge</h6>
                                        <p class="disc">  Our team of placement specialists possesses in-depth knowledge of the manpower industry, including the latest trends, best practices, and regulatory requirements. We stay updated on manpower planning strategies, talent management approaches, employee engagement techniques, and workforce optimization methods. </p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
