        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 breadcrumb-1">
                    <h1 class="title" style="font-size: 38px;">Placement  Service for Manpower  (Candidate)</h1>
                </div>
            ...
            <div class="row">
                <div class="col-xl-7 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="service-detials-step-1">
                        <div class="thumbnail">
                            <img loading="lazy" src="{{ asset('image/consultancy10.jpg') }}" alt="business-area">
                        </div>
                        <h4 class="title">Placement  Service for Manpower  (Candidate)</h4>
                        <p class="disc">
                           Welcome to our Placement Service for Manpower Candidates! If you are a skilled professional in the field of manpower management and looking for new job opportunities, our service is here to assist you in finding the right placement. 
                        </p>
                        ...
                        <div class="row g-5 mt--30 mb--40">
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Diverse Job Opportunities</h6>
                                        <p class="disc">Our placement service connects with a wide range of organizations that require manpower professionals. We have partnerships with companies across various industries, including manufacturing, construction, healthcare, logistics, hospitality, and more.  </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Specialized Manpower Roles</h6>
                                        <p class="disc">We understand that manpower management encompasses various roles and responsibilities. Whether you specialize in areas such as workforce planning, talent acquisition, training and development, performance management, or employee relations, we can match you with job opportunities that align with your skills and expertise. </p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Expertise in Manpower Industry</h6>
                                        <p class="disc"> Our team of placement specialists possesses a deep understanding of the manpower industry. We stay updated on the latest trends, regulations, and best practices in manpower management. With our industry knowledge, we can provide you with valuable insights, guidance, and support throughout your job search.</p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
							<div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Skill Assessment and Career Development</h6>
                                        <p class="disc">   We assess your skills, qualifications, and experience to match you with suitable job opportunities. Our placement service also offers skill enhancement and career development support. We provide resources and guidance to help you enhance your manpower management skills, update your resume, and prepare for interviews. </p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
