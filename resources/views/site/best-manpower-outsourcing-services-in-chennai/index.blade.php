        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 breadcrumb-1">
                    <h1 class="title" style="font-size: 38px;">Manpower Outsourcing Services</h1>
                </div>
            ...
            <div class="row">
                <div class="col-xl-7 col-md-12 col-sm-12 col-12">
                    ...
                    <div class="service-detials-step-1">
                        <div class="thumbnail">
                            <img loading="lazy" src="{{ asset('image/consultancy11.png') }}" alt="business-area">
                        </div>
                        <h4 class="title">Manpower Outsourcing Services</h4>
                        <p class="disc">
                          Our Manpower Outsourcing Services offer organizations the opportunity to optimize their workforce management by outsourcing specific functions or entire teams to experienced and skilled professionals. With our expertise in manpower management, we provide flexible and cost-effective solutions that help businesses streamline operations, enhance productivity, and focus on core business objectives. 
                        </p>
                        ...
                        <div class="row g-5 mt--30 mb--40">
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Access to Skilled Professionals</h6>
                                        <p class="disc">By outsourcing your manpower requirements to us, you gain access to a pool of skilled professionals with expertise in various fields. We have a wide network of qualified individuals across different industries, including administration, customer service, IT support, finance, human resources, and more.  </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Cost Savings</h6>
                                        <p class="disc">Outsourcing your manpower needs can lead to significant cost savings for your organization. With our services, you can avoid the expenses associated with recruiting, training, and maintaining an in-house workforce. We take care of the recruitment, onboarding, payroll, benefits, and other administrative tasks, allowing you to reduce overhead costs and allocate resources more efficiently. </p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
                            <div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Flexibility and Scalability</h6>
                                        <p class="disc"> Our Manpower Outsourcing Services offer flexibility and scalability to meet your changing business needs. Whether you require temporary staff for a specific project, additional workforce during peak seasons, or a long-term solution for ongoing operations, we can customize our services accordingly. </p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
							<div class="col-lg-6">
                                ...
                                <div class="service-details-card">
                                    ...
                                    <div class="details">
                                        <h6 class="title">Focus on Core Competencies</h6>
                                        <p class="disc">   By outsourcing non-core functions to our experts, you can focus on your organization's core competencies and strategic initiatives.  Our team takes care of the day-to-day operational tasks, allowing you to concentrate on what you do best.</p>
                                    </div>
                                </div>
                                <!-- single service details card End -->
                            </div>
