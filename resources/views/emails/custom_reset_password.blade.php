...
<head>
  ...
  <title>Your New Password – Wintech Inc</title>
</head>
        ...
        <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;width:100%;">
          ...
          <tr>
            <td style="background:linear-gradient(135deg,#071056 0%,#ba1c26 100%);border-radius:16px 16px 0 0;padding:36px 40px;text-align:center;">
              ...
              <div style="margin-bottom:12px;"><img loading="lazy" src="https://img.icons8.com/ios-filled/100/ffffff/key.png" alt="Icon" style="height:48px;width:48px;display:inline-block;"></div>
                  ...
                  <td style="background:#f8f9fa;border-radius:10px;padding:20px 24px;">
                    ...
                    <table cellpadding="0" cellspacing="0">
                      ...
                      <tr>
                        ...
                        <td style="padding:5px 0;font-size:14px;color:#555;line-height:1.5;">Go to <strong>Settings → Change Password</strong>.</td>
                      </tr>
                      <tr>
                        <td style="padding:5px 0;vertical-align:top;">
                ...
                <tr>
                  <td style="background:#fff8f0;border-left:4px solid #ff9800;border-radius:0 8px 8px 0;padding:14px 18px;">
                    <p style="margin:0;font-size:13px;color:#7a4f00;line-height:1.6;">
                      ⚠️ <strong>Didn't request this?</strong> If you did not request a password reset, please ignore this email. Your account remains secure.
                    </p>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="background:#071056;border-radius:0 0 16px 16px;padding:28px 40px;text-align:center;">
              ...
              <p style="margin:0 0 14px;color:rgba(255,255,255,0.5);font-size:12px;">Staffing · Recruitment · IT Solutions</p>
