                    ...
                    <table cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td style="padding:6px 0;vertical-align:top;width:34px;">
                          <span style="display:inline-block;width:24px;height:24px;text-align:center;line-height:24px;background:#ba1c26;color:#fff;border-radius:50%;font-size:11px;font-weight:700;">1</span>
                        </td>
                      ...
                      <tr>
                        <td style="padding:6px 0;vertical-align:top;width:34px;">
                          <span style="display:inline-block;width:24px;height:24px;text-align:center;line-height:24px;background:#ba1c26;color:#fff;border-radius:50%;font-size:11px;font-weight:700;">2</span>
                        </td>
                      ...
                      <tr>
                        <td style="padding:6px 0;vertical-align:top;width:34px;">
                          <span style="display:inline-block;width:24px;height:24px;text-align:center;line-height:24px;background:#ba1c26;color:#fff;border-radius:50%;font-size:11px;font-weight:700;">3</span>
                        </td>
